...
const TETROMINOES = {
    ...
    O: { shape: [[1, 1], [1, 1]], color: 'tetris-o' }, // Yellow
    T: { shape: [[0, 1, 0], [1, 1, 1]], color: 'tetris-t' }, // Purple
    S: { shape: [[0, 1, 1], [1, 1, 0]], color: 'tetris-s' }, // Green
    Z: { shape: [[1, 1, 0], [0, 1, 1]], color: 'tetris-z' }, // Red
    J: { shape: [[1, 0, 0], [1, 1, 1]], color: 'tetris-j' }, // Blue
    L: { shape: [[0, 0, 1], [1, 1, 1]], color: 'tetris-l' } // Orange
};
